...
#restaurantes = ['Pizza', 'Sushi'] #Lista
restaurantes = [{'nome':'Praça', 'categoria': 'Japonesa', 'ativo':False},
                {'nome':'Pizza Suprema', 'categoria': 'Pizza', 'ativo':True},
                {'nome':'Cantina', 'categoria': 'Italiana', 'ativo':False}] #Dicionário
...
def alternar_estado_restaurante():
    '''Essa função é responsável por alterar o status do restaurantes(Ativado e desativado)'''
    exibir_subtitulo('Alternando estado do restaurante')
    nome_restaurante = input('Digite o nome do restaurante que deseja alterar o estado: ')
    restaurante_encontrado = False

    for restaurante in restaurantes['nome']:
